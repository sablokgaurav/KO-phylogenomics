...
This repository contains the R code which i coded using the mathematical expression for the genome based ontologies annotation and the phylogenomics informativeness.Although i coded this for plants but this is applicable to any genome annotations. 
Gaurav Sablok
